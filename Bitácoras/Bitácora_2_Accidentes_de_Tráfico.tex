...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{resumen_categoricas.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{original_contingency_table_carretera.jpg}
\caption{\label{fig:occarretera}Tabla de Contingencia: Severidad vs Carretera}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{original_contingency_table_clima.jpg}
\caption{\label{fig:occlima}Tabla de Contingencia: Severidad vs Clima}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{original_contingency_table_festivos.jpg}
\caption{\label{fig:ocfestivos}Tabla de Contingencia: Severidad vs Festivos}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{original_contingency_table_iluminación.jpg}
\caption{\label{fig:ociluminación}Tabla de Contingencia: Severidad vs Iluminación}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{contingency_table_carretera.jpg}
\caption{\label{fig:ccarretera}Tabla de Contingencia: Severidad vs Carretera}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{contingency_table_clima.jpg}
\caption{\label{fig:cclima}Tabla de Contingencia: Severidad vs Clima}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{contingency_table_festivos.jpg}
\caption{\label{fig:cfestivos}Tabla de Contingencia: Severidad vs Festivos}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{contingency_table_iluminación.jpg}
...
\subsubsection{Limitaciones del análisis de correlación para variables categóricas}

\textbf{Resumen en una oración:} La correlación no es adecuada para evaluar la independencia entre variables categóricas sin un orden natural definido.

\textbf{Principal característica:} El análisis de independencia entre variables categóricas debe realizarse mediante tablas de contingencia y pruebas estadísticas como el chi-cuadrado, no con coeficientes de correlación.

\textbf{Problemas o posibles desafíos:} Interpretar coeficientes de correlación sobre variables categóricas puede inducir a error si no se considera que estas no tienen necesariamente un orden inherente; además, puede llevar a conclusiones engañosas al tratar datos nominales como si fueran cuantitativos.

\textbf{Resumen en un párrafo:} Aunque las variables categóricas pueden ser codificadas numéricamente para calcular correlaciones, este procedimiento no garantiza que los resultados reflejen relaciones significativas, especialmente cuando las categorías no tienen un orden natural (como colores, zonas geográficas o tipos de carretera). Por esta razón, se recomienda utilizar pruebas de independencia como la prueba chi-cuadrado sobre tablas de contingencia, que toman en cuenta la frecuencia observada y esperada de cada combinación de categorías, proporcionando una mejor base para evaluar relaciones estadísticas entre variables categóricas.

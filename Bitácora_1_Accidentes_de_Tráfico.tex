...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{images/V_Gowin_b1.png}
...
De acuerdo con \cite(BuitragoRamírezFrancisco2019Vpdv), los diversos factores que podrían llegatr a influir en la severidad de un accidente de tránsito estan los factores humanos, vehiculares, ambientales y de infraestructura. Entres ellos más especificamente se encuentra la atención, concentración y condición psíquico-física del conductor, las características de los vehículos, los objetos y la carga transportada, las condiciones meteorológicas, el ámbito urbano o interurbano en el que ocurre el accidente y el estado de las carreteras.
